...
def _getDirectory(pntXlsx, plyObjList, plyTotalExtent):
    ...
    print(pntStyleIndex, xCenIndex, yCenIndex, zCenIndex)
    print(sht.cell(1, pntStyleIndex).value, sht.cell(1, xCenIndex).value,
          sht.cell(1, yCenIndex).value, sht.cell(1, zCenIndex).value)
    print(maxRow, maxCol)
...
def selectTargetData(inGDB, outputGDB):
    ...
    plyList = arcpy.ListFeatureClasses("*LINE*")
...
def main(pnt, ply, outputPath):
    ...
    print(pntXls)
    print(plyXls)
    print(plyTotalExtent)

    # pntFieldList = ['OBJECTID', 'FEATURECOD', 'GXDM', 'WTDH', 'TSDH', 'YSDM', 'TFH', 'XZB', 'YZB', 'DMGC', 'TZD', 'FSW',
    #                 'SZDL', 'JSDM', 'XZJ', 'JS', 'JGXZ', 'JGCZ', 'JGZJ', 'JGC', 'JGK', 'JXJCZ', 'JBS', 'JSZJ', 'QSDW',
    #                 'TCDW', 'TCRQ', 'SJLY', 'BZ', 'PRJNO', 'DLPRJNO', 'DDATE', 'DUSER', 'RKDATE', 'ISLOCK', 'NODEID',
    #                 'ULPRJNO', 'SSQY', 'YLQY', 'CZ', 'GTLX', 'BHGD', 'GG_FGG', 'UL_NAME', 'DSDX', 'SSQY_TMP',
    #                 'STYLE_TYPE', 'JTZJ', 'JS_1', 'x_cen_', 'y_cen_', 'z_cen_', 'unic_id_']
    # plyFieldList = ['OBJECTID', 'FEATURECOD', 'GXDM', 'QDDH', 'ZDDH', 'QDGC', 'ZDGC', 'QDMS', 'ZDMS', 'MSLX', 'CZ',
    #                 'GJ', 'DYZ', 'YL', 'LX', 'ZKS', 'ZYKS', 'DLTS', 'BHCZ', 'XX', 'YSDM', 'SZDL', 'QSDW', 'JSND',
    #                 'TCDW', 'TCRQ', 'SYZT', 'SJLY', 'BZ', 'PRJNO', 'DLPRJNO', 'DDATE', 'DUSER', 'RKDATE', 'ISLOCK',
    #                 'SNODID', 'ENODID', 'JZ', 'ULPRJNO', 'SSQY', 'YLQY', 'XLMC', 'HLS', 'GG_FGG', 'UL_NAME', 'DSDX',
    #                 'SSQY_TMP', 'Shape_Leng', 'QDMS_1', 'ZDMS_1', 'new_z_f_', 'new_z_l_', 'gj_num_', 'x_f_', 'y_f_',
    #                 'z_f_', 'x_l_', 'y_l_', 'z_l_', 'unic_id_']
    # plyTotalExtent = (328582.94995117374, 345062.1806030292, 330783.8420410175, 347713.3693847675)
    # pntXls = r"E:\南京管线\代码_三通四通\代码测试数据\RQ_TRQ_POINT_SEL.xlsx"
    # plyXls = r"E:\南京管线\代码_三通四通\代码测试数据\RQ_TRQ_LINE.xlsx"
    ...
    # generateNewRoll_X(pnt_res_xlsx)
...
# pntData = r"E:\南京管线\代码_三通四通\aprx\南京管线三通四通\data\管线数据最终二维数据.gdb\XX_TXX_POINT"
# plyData = r"E:\南京管线\代码_三通四通\aprx\南京管线三通四通\data\管线数据最终二维数据.gdb\XX_TXX_LINE"
# outputPath = r"E:\南京管线\代码_三通四通\代码测试数据\add_z"
#
# main(pntData, plyData, outputPath)

inGDB = r"E:\南京管线\代码_三通四通\代码测试数据\data\管线数据最终二维数据.gdb"
outputGDB = r"E:\南京管线\代码_三通四通\代码测试数据\data\res.gdb"
outputPath = r"E:\南京管线\代码_三通四通\代码测试数据\data\res_xlsx_0.1m"
