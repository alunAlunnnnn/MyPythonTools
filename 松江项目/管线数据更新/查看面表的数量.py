...
gdb = r'E:\sjgl_sjgx\SJ99-2019松江维护合库.gdb'
...
f1 = open(r'E:\sjgl_sjgx\res\有效plg测试\SJ99-2019_tableNo.txt', 'w', encoding='utf-8')
f2 = open(r'E:\sjgl_sjgx\res\有效plg测试\SJ99-2019_tableName.txt', 'w', encoding='utf-8')

print(tabList)
for each in tabList:
    if each[-1:] == '3':
        f1.write(each + '\n')
        f2.write(tabNameMapping[each] + '\n')
        print(each)
        print(tabNameMapping[each])
