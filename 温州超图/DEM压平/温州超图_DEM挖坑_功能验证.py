...
# inRas = r"F:\工作项目\项目_温州超图\研发_DEM挖坑\数据_原始数据\ASTGTM_N28E120X.tif"
inRas = r"F:\工作项目\项目_温州超图\研发_DEM挖坑\数据_原始数据\建筑.gdb\ASTGTM_N28E120X"
...
inPlg = r"F:\工作项目\项目_温州超图\研发_DEM挖坑\工程_DEM挖坑测试\温州_DEM挖坑\温州_DEM挖坑.gdb\plg_buffer"
outputPath = r"F:\工作项目\项目_温州超图\研发_DEM挖坑\数据_中间数据\tempRas.gdb"
outputName = r"ff.tif"
